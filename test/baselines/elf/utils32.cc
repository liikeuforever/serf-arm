...
static const int mapSPGreater1[] =
    {1, 10, 100, 1000, 10000, 100000, 1000000, 10000000,
     100000000, 1000000000};

static const float mapSPLess1[] =
...
static int* getSPAnd10iNFlag(float v);
...
int* getAlphaAndBetaStar(float v, int lastBetaStar) {
  v = v < 0 ? -v : v;
...
float roundUp(float v, int alpha) {
