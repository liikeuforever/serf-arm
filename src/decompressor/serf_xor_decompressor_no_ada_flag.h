#ifndef SERF_XOR_DECOMPRESSOR_NO_ADA_FLAG_H_
#define SERF_XOR_DECOMPRESSOR_NO_ADA_FLAG_H_
...
class SerfXORDecompressorNoAdaFlag {
 public:
  explicit SerfXORDecompressorNoAdaFlag(long adjust_digit) : adjust_digit_(adjust_digit) {};
...
#endif // SERF_XOR_DECOMPRESSOR_NO_ADA_FLAG_H_
