...
Array<int>
PostOfficeSolver32::InitRoundAndRepresentation(Array<int> &distribution,
    ...
    // 最多用4个bit来表示
    int max_z = std::min(
            kPositionLength2Bits[total_count_and_non_zeros_counts[1]], 4);
    ...
    for (int z = 0; z <= max_z; z++) {
        ...
        PostOfficeResult por = PostOfficeSolver32::
...
int PostOfficeSolver32::WritePositions(Array<int> &positions,
                                       OutputBitStream *out) {
...
Array<int>
PostOfficeSolver32::CalTotalCountAndNonZerosCounts(Array<int> &arr,
                                                   Array<int>
...
PostOfficeResult
PostOfficeSolver32::BuildPostOffice(Array<int> &arr, int num,
                                    int non_zeros_count,
