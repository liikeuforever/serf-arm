#include "TensorXORCompressTransaction.h"

TensorXORCompressTransaction::TensorXORCompressTransaction(int d1, int d2, int d3, int d4): compressor_array_len(d1 * d2 * d3 * d4) {
...
std::vector<std::vector<uint8_t>> TensorXORCompressTransaction::compress_tensor(std::vector<double> flat_tensor) {
